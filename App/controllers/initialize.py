...
def initialize():
    ...
    create_listing(2, 'Apartment 2', 1, 1, 1000, 'New York', 'images/apartment.jpg', 'Nice')
    create_listing(2, 'Apartment 3', 1, 1, 1000, 'New York', 'images/apartment.jpg', 'Nice')
    create_listing(2, 'Apartment 4', 1, 1, 1000, 'New York', 'images/apartment.jpg', 'Nice')
